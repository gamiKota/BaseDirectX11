...
//	// ワールドマトリックス
//	XMStoreFloat4x4(&m_transform, XMMatrixTranslation(c.x, c.y, c.z));
//
//	return hr;
//}
//
...
//	// 現在位置を保存&クリア
//	XMFLOAT3 pos = { m_transform._41, m_transform._42, m_transform._43 };
...
//	pos.z += m_velocity.z;
//	// 回転
//	XMStoreFloat4x4(&m_transform, XMMatrixMultiply(XMLoadFloat4x4(&m_transform),
